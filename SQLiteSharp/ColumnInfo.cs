...
public record ColumnInfo {
    ...
    /// </summary>
    [Alias("cid")] public int ColumnIndex { get; set; }
    /// <summary>
    ...
    /// </summary>
    [Alias("notnull")] public bool NotNull { get; set; }
    /// <summary>
    /// The default value for the column when inserting rows.
    /// </summary>
    [Alias("dflt_value")] public SqliteValue DefaultValue { get; set; }
    /// <summary>
    /// Whether the column is the primary key of the table.
    /// </summary>
    [Alias("pk")] public bool PrimaryKey { get; set; }
}